 ...
 * @author javie
 */
public class Actualizacion_Prod extends javax.swing.JFrame {

    /**
     * Creates new form Actualizacion_Prod
     */
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Id de Factura");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 260, -1, -1));
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 200, 170, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Actualizacion_Prod.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Actualizacion_Prod().setVisible(true);
            }
        });
    }
